(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[3485],{91474:function(e,t,r){Promise.resolve().then(r.bind(r,5042))},5042:function(e,t,r){"use strict";r.r(t),r.d(t,{default:function(){return f}});var l=r(57437),c=r(2265),n=r(8400),s=r(71322),a=r(75733),o=r(47019),i=r(13231),d=r(49590),u=r(97643);function f(){let[e,t]=(0,c.useState)([]),[r,f]=(0,c.useState)(!1),h=(0,c.useRef)(null),y=(0,c.useRef)(null);function m(e){e.preventDefault();let r=h.current,l=y.current;null!==r&&null!==l&&r!==l&&(t(e=>{let t=[...e],[c]=t.splice(r,1);return t.splice(l,0,c),t}),h.current=null,y.current=null)}function p(){h.current=null,y.current=null}(0,c.useEffect)(()=>{let e=(0,u.yn)(),r=new Map(e.map(e=>[e.key,e.visible])),l=[];e.forEach(e=>{var t;let{key:c}=e,n=u.Ri.find(e=>e.key===c);n&&l.push({key:c,visible:null===(t=r.get(c))||void 0===t||t,item:n})}),u.Ri.forEach(e=>{l.find(t=>t.key===e.key)||l.push({key:e.key,visible:!0,item:e})}),t(l)},[]);let x=e.filter(e=>e.visible).slice(0,8);return(0,l.jsxs)("div",{className:"space-y-5",children:[(0,l.jsxs)("div",{children:[(0,l.jsxs)("h1",{className:"text-xl font-bold flex items-center gap-2",style:{color:"#1a2744"},children:[(0,l.jsx)(n.Z,{className:"w-5 h-5",style:{color:"#1d6ae5"}}),"เมนูด่วน (มือถือ)"]}),(0,l.jsx)("p",{className:"text-sm mt-1",style:{color:"#4a6080"},children:"จัดลำดับและเลือกเมนูที่แสดงในหน้าหลัก (มือถือ) — แสดงได้สูงสุด 8 รายการ"})]}),(0,l.jsxs)("div",{className:"grid xl:grid-cols-2 gap-5 items-start",children:[(0,l.jsxs)("div",{className:"card space-y-1",children:[(0,l.jsx)("p",{className:"text-xs font-semibold uppercase tracking-wider mb-3",style:{color:"#94a3b8"},children:"ลากเพื่อเรียงลำดับ"}),e.map((r,c)=>{let{item:n,visible:i}=r;return(0,l.jsxs)("div",{draggable:!0,onDragStart:e=>{h.current=c,e.dataTransfer.effectAllowed="move"},onDragOver:e=>{e.preventDefault(),e.dataTransfer.dropEffect="move",y.current=c},onDrop:m,onDragEnd:p,className:"flex items-center gap-3 px-3 py-2.5 rounded-lg border cursor-grab active:cursor-grabbing select-none transition-colors",style:{backgroundColor:i?"#f5f8ff":"#f8fafc",borderColor:i?"#dce6f9":"#e2e8f0",opacity:i?1:.6},children:[(0,l.jsx)(s.Z,{className:"w-4 h-4 flex-shrink-0",style:{color:"#94a3b8"}}),(0,l.jsx)("div",{className:"w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0",style:{backgroundColor:n.bg},children:(0,l.jsx)(n.Icon,{className:"w-4 h-4",style:{color:n.color}})}),(0,l.jsxs)("div",{className:"flex-1 min-w-0",children:[(0,l.jsx)("p",{className:"text-sm font-medium truncate",style:{color:"#1a2744"},children:n.label}),(0,l.jsx)("p",{className:"text-[11px]",style:{color:"#94a3b8"},children:n.key})]}),i&&(()=>{let t=e.filter((e,t)=>e.visible&&t<=c).length-1,r=t<8;return(0,l.jsx)("span",{className:"text-[10px] font-bold px-1.5 py-0.5 rounded-full flex-shrink-0",style:{backgroundColor:r?"#e8f0fe":"#f1f5f9",color:r?"#1d6ae5":"#94a3b8"},children:r?"#".concat(t+1):"ซ่อน (เกิน 8)"})})(),(0,l.jsx)("button",{onClick:()=>{var e;return e=n.key,void t(t=>t.map(t=>t.key===e?{...t,visible:!t.visible}:t))},className:"flex-shrink-0 p-1 rounded-lg transition-colors hover:bg-white",title:i?"ซ่อนเมนูนี้":"แสดงเมนูนี้",children:i?(0,l.jsx)(a.Z,{className:"w-4 h-4",style:{color:"#1d6ae5"}}):(0,l.jsx)(o.Z,{className:"w-4 h-4",style:{color:"#94a3b8"}})})]},n.key)})]}),(0,l.jsxs)("div",{className:"space-y-4 xl:sticky xl:top-4",children:[(0,l.jsxs)("div",{className:"card",children:[(0,l.jsx)("p",{className:"text-xs font-semibold uppercase tracking-wider mb-3",style:{color:"#94a3b8"},children:"ตัวอย่างการแสดงผล (มือถือ)"}),0===x.length?(0,l.jsx)("p",{className:"text-sm text-center py-6",style:{color:"#94a3b8"},children:"ไม่มีเมนูที่เปิดใช้งาน"}):(0,l.jsx)("div",{className:"mx-auto max-w-[280px]",children:(0,l.jsxs)("div",{className:"rounded-2xl p-4 shadow-inner",style:{backgroundColor:"#f5f8ff",border:"1px solid #dce6f9"},children:[(0,l.jsxs)("div",{className:"flex items-center justify-between mb-3",children:[(0,l.jsx)("p",{className:"text-xs font-semibold",style:{color:"#1a2744"},children:"เมนูด่วน"}),(0,l.jsx)("span",{className:"text-[10px]",style:{color:"#1d6ae5"},children:"ดูทั้งหมด →"})]}),(0,l.jsx)("div",{className:"grid grid-cols-4 gap-2",children:x.map(e=>{let{item:t}=e;return(0,l.jsxs)("div",{className:"flex flex-col items-center gap-1.5 p-2 rounded-xl",style:{backgroundColor:t.bg},children:[(0,l.jsx)("div",{className:"w-9 h-9 rounded-xl flex items-center justify-center",style:{backgroundColor:t.bg},children:(0,l.jsx)(t.Icon,{className:"w-4 h-4",style:{color:t.color}})}),(0,l.jsx)("span",{className:"text-[9px] font-medium text-center leading-tight",style:{color:"#1a2744"},children:t.label})]},t.key)})})]})}),(0,l.jsxs)("p",{className:"text-[11px] text-center mt-3",style:{color:"#94a3b8"},children:["แสดง ",x.length,"/8 เมนู"]})]}),(0,l.jsxs)("div",{className:"flex flex-col gap-2.5",children:[(0,l.jsx)("button",{onClick:function(){let t=e.map(e=>{let{key:t,visible:r}=e;return{key:t,visible:r}});(0,u.xf)(t),f(!0),setTimeout(()=>f(!1),2e3)},className:"w-full flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-semibold text-white transition-all",style:{backgroundColor:r?"#10b981":"#1d6ae5"},children:r?(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(i.Z,{className:"w-4 h-4"})," บันทึกแล้ว!"]}):"บันทึกการตั้งค่า"}),(0,l.jsxs)("button",{onClick:function(){let e=u.Ri.map((e,t)=>({key:e.key,visible:t<8}));(0,u.xf)(e),t(u.Ri.map((e,t)=>({key:e.key,visible:t<8,item:e}))),f(!0),setTimeout(()=>f(!1),2e3)},className:"w-full flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-medium transition-colors",style:{backgroundColor:"#f5f8ff",color:"#4a6080",border:"1px solid #dce6f9"},children:[(0,l.jsx)(d.Z,{className:"w-3.5 h-3.5"})," รีเซ็ตเป็นค่าเริ่มต้น"]})]}),(0,l.jsxs)("div",{className:"rounded-xl px-4 py-3 text-xs",style:{backgroundColor:"#fffbeb",border:"1px solid #fef3c7",color:"#92400e"},children:[(0,l.jsx)("p",{className:"font-semibold mb-1",children:"หมายเหตุ"}),(0,l.jsxs)("ul",{className:"space-y-1 list-disc pl-4",children:[(0,l.jsx)("li",{children:"การตั้งค่านี้จะบันทึกเฉพาะในเบราว์เซอร์นี้"}),(0,l.jsx)("li",{children:"เมนูที่ไม่มีสิทธิ์ใช้งานจะถูกซ่อนอัตโนมัติ"}),(0,l.jsx)("li",{children:"แสดงได้สูงสุด 8 เมนูในหน้าหลัก"})]})]})]})]})]})}},97643:function(e,t,r){"use strict";r.d(t,{Ri:function(){return y},yw:function(){return k},yn:function(){return p},xf:function(){return x}});var l=r(85302),c=r(73045),n=r(10724),s=r(52891),a=r(60360),o=r(33855),i=r(47215);/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */let l=(0,r(78030).Z)("CalendarX",[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M3 10h18",key:"8toen8"}],["path",{d:"m14 14-4 4",key:"rymu2i"}],["path",{d:"m10 14 4 4",key:"3sz06r"}]])},13231:function(e,t,r){"use strict";r.d(t,{Z:function(){return l}});/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */let l=(0,r(78030).Z)("CircleCheck",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]])},64590:function(e,t,r){"use strict";r.d(t,{Z:function(){return l}});/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */let l=(0,r(78030).Z)("Eye",[["path",{d:"M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z",key:"rwhkz3"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]])},71322:function(e,t,r){"use strict";r.d(t,{Z:function(){return l}});/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */let l=(0,r(78030).Z)("GripVertical",[["circle",{cx:"9",cy:"12",r:"1",key:"1vctgf"}],["circle",{cx:"9",cy:"5",r:"1",key:"hp0tcf"}],["circle",{cx:"9",cy:"19",r:"1",key:"fkjjf6"}],["circle",{cx:"15",cy:"12",r:"1",key:"1tmaij"}],["circle",{cx:"15",cy:"5",r:"1",key:"19l28e"}],["circle",{cx:"15",cy:"19",r:"1",key:"f4zoj3"}]])},85302:function(e,t,r){"use strict";r.d(t,{Z:function(){return l}});/**
 * @license lucide-react v0.400.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
